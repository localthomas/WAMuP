...
import { IAudioMetadata, parseBlob, parseBuffer, selectCover } from "music-metadata-browser";
 ...
 */
export async function getMetadata(file: Blob, fileName: string): Promise<Metadata> {
